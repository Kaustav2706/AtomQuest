    ...
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h2 className="text-2xl font-bold tracking-tight">Add New Goal</h2>
          <p className="text-sm text-muted-foreground">Define a new target performance objective.</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Specify targeted parameters, weights, and deadlines.</CardDescription>
        </CardHeader>
